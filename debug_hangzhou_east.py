...
def debug_query():
    ...
    try:
        ...
        # 3. 发送查询请求（杭州东）
        logger.info("3. 发送查询请求（杭州东）...")
        query_url = "https://kyfw.12306.cn/otn/leftTicket/query"
        params = {
            "leftTicketDTO.train_date": "2026-02-20",  # 不同的日期
            "leftTicketDTO.from_station": "BHZ",  # 北海
            "leftTicketDTO.to_station": "HGH",    # 杭州东
            "purpose_codes": "ADULT"
        }
        ...
        # 保存响应内容到文件
        debug_file = "debug_beihai_hangzhou_east.json"
